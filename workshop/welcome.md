...
1. [**Get Set Up**](../step-01/) - Create an account or log into Github, get set up on your local machine
2. [**Use Overpass to Create an OpenStreetMap Extract**](../step-02/) - Extract Te Ara Hura trail data
3. [**Use Maplibre to Render Your Map**](../step-03/) - Set up local server and create your first map
...
Ready to begin? Start with [Step 1 - Get Set Up](../step-01/)!
